...
import { missionEventService } from '@/lib/api/missionEventService.js';
import { SERVICE_CATALOG, getResourceSummary, type ServiceDefinition } from '@/lib/api/serviceCatalog.js';
